...
using Nhom3.Sessions;
using Nhom3.Web.Controllers.Results;
using Nhom3.Web.Models;
using Nhom3.Web.Models.Account;
...
{
    public class AccountController : Nhom3ControllerBase
    {
